...
def predict_single_email(email_text):
    ...
    final_confidence = spam_prob  # use spam confidence consistently
...
def predict_csv():
    ...
    try:
        ...
        # Find label column (OPTIONAL - for accuracy calculation)
        ...
        print(f"Using columns - Message: '{text_col}', Subject: '{subject_col}', Label: '{label_col}' (optional)")
